...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: [designSystem.typography.fonts.primary],
        jp: [designSystem.typography.fonts.secondary],
        mono: [designSystem.typography.fonts.mono],
        display: [designSystem.typography.fonts.display],
        cursive: [designSystem.typography.fonts.cursive],
      },
      fontSize: {
